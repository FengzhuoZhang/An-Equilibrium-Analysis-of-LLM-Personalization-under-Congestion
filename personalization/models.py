...
class TransformerModel(nn.Module):
    ...
    #   seq_len = zs.shape[1]                                                                                                                                                  
    #   max_trained_len = self.n_positions * 2  # Original trained length                                                                                                      
                                                                                                                                                                             
    #   if seq_len > max_trained_len:                                                                                                                                          
    #       # Position interpolation: scale positions to fit trained range                                                                                                     
    #       scale = (max_trained_len - 1) / (seq_len - 1)                                                                                                                      
    #       position_ids = (torch.arange(seq_len, device=xs.device).float() * scale).long()                                                                                    
    #       position_ids = position_ids.unsqueeze(0).expand(zs.shape[0], -1)                                                                                                   
